let bankroll=toFixed(document.getElementById("bankroll").value);
let aggro=toFixed(document.getElementById("aggro").value);
let parlaysize=toFixed(document.getElementById("parlaysize").value);

function kellyCalc1() {
    let prob1=toFixed(document.getElementById("prob1").value);
    let odds1=toFixed(document.getElementById("odds1").value);
...
function kellyCalc2() {
    let prob2=toFixed(document.getElementById("prob2").value);
    let odds2=toFixed(document.getElementById("odds2").value);
...
function kellyCalc3() {
    let prob3=toFixed(document.getElementById("prob3").value);
    let odds3=toFixed(document.getElementById("odds3").value);
...
function kellyCalc4() {
    let prob4=toFixed(document.getElementById("prob4").value);
    let odds4=toFixed(document.getElementById("odds4").value);
...
function kellyCalc5() {
    let prob5=toFixed(document.getElementById("prob5").value);
    let odds5=toFixed(document.getElementById("odds5").value);
...
function kellyCalc6() {
    let prob6=toFixed(document.getElementById("prob6").value);
    let odds6=toFixed(document.getElementById("odds6").value);
...
function kellyCalc7() {
    let prob7=toFixed(document.getElementById("prob7").value);
    let odds7=toFixed(document.getElementById("odds7").value);
...
function kellyCalc8() {
    let prob8=toFixed(document.getElementById("prob8").value);
    let odds8=toFixed(document.getElementById("odds8").value);
...
function kellyCalc9() {
    let prob9=toFixed(document.getElementById("prob9").value);
    let odds9=toFixed(document.getElementById("odds9").value);
...
function kellyCalc10() {
    let prob10=toFixed(document.getElementById("prob10").value);
    let odds10=toFixed(document.getElementById("odds10").value);
...
function kellyCalc11() {
    let prob11=toFixed(document.getElementById("prob11").value);
    let odds11=toFixed(document.getElementById("odds11").value);
